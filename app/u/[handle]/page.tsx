        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-4">
              <div className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-fuchsia-500 text-xl font-bold">
          ...
          {!isSelf && !blocked && (
            <div className="mt-5 flex flex-wrap items-center gap-2">
              ...
              <form action={startDmAction}>
                <input type="hidden" name="targetId" value={profile.id} />
                <button className="rounded-lg border border-white/15 px-4 py-2 text-sm font-semibold text-white/80 transition hover:bg-white/5">
                  Message
                </button>
              </form>
          ...
          {isSelf && <p className="mt-5 text-sm text-white/40">This is you.</p>}
          {blocked && <p className="mt-5 text-sm text-white/40">You can't interact with this account.</p>}
        </div>
